...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    // var shrub = createSprite(camera.position+250,300,40,10);
    // var shrub = createSprite(camera.position.x+250,300,40,10);
    // var shrub = createSprite(camera.positionX+250,300,40,10);
    // var shrub = createSprite(Camera.position.x+250,300,40,10);
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
     ...
     //var obstacle = createSprite(camera.Position.X+200,330,40,40);
    // var obstacle = createSprite(Camera.Position.x+200,330,40,40);
     var obstacle = createSprite(camera.position.x+200,330,40,40);
    // var obstacle = createSprite(camera.position.x.200,330,40,40);
